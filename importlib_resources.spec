...
Source0  : https://files.pythonhosted.org/packages/b1/7a/b9e2309e5c619ba3da8806e43bb17873ec6eab22a3d79347778c80563028/importlib_resources-5.2.2.tar.gz
...
%prep
%setup -q -n importlib_resources-5.2.2
cd %{_builddir}/importlib_resources-5.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629210897
...
cp %{_builddir}/importlib_resources-5.2.2/LICENSE %{buildroot}/usr/share/package-licenses/importlib_resources/3cd2faf9a752b7838f4b6a634116c24cc3053415
