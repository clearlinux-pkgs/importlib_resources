...
Version  : 5.2.3
Release  : 2
URL      : https://files.pythonhosted.org/packages/e6/eb/9a21e2ae696a0530c73304f9d1d3c063065f82d3562822b55466c6ef62ef/importlib_resources-5.2.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/e6/eb/9a21e2ae696a0530c73304f9d1d3c063065f82d3562822b55466c6ef62ef/importlib_resources-5.2.3.tar.gz
...
%prep
%setup -q -n importlib_resources-5.2.3
cd %{_builddir}/importlib_resources-5.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634579156
...
cp %{_builddir}/importlib_resources-5.2.3/LICENSE %{buildroot}/usr/share/package-licenses/importlib_resources/3cd2faf9a752b7838f4b6a634116c24cc3053415
