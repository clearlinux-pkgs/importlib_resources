...
%prep
%setup -q -n importlib_resources-5.3.0
cd %{_builddir}/importlib_resources-5.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634596466
...
cp %{_builddir}/importlib_resources-5.3.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_resources/3cd2faf9a752b7838f4b6a634116c24cc3053415
